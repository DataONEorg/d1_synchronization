...
//                new ClassPathXmlApplicationContext(new String[]{"/org/dataone/cn/batch/proto/mercury/applicationContext.xml"});
                new FileSystemXmlApplicationContext(new String[]{"file:/etc/dataone/mercury/dbharvester/applicationContext.xml"});

        Harvester harvester = (Harvester) context.getBean("harvester", Harvester.class);
        harvester.harvest();
    }
